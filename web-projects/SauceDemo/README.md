...
- **Test_Cases/** → Casos de prueba organizados por módulos (Login, Cart, Checkout, API).
- **Bug_Reports/** → Registro de defectos encontrados durante la ejecución.
- **Automation/Cypress/** → Scripts de automatización para flujos críticos.
